...
If you replace all pointers in your program by these smart pointers,
...
set for DOS or Windows (Win95, Win98, WinNT) and the Microsoft VC++ compiler.
...
This software is Copyright (C) of Code Farms Inc., remains a property
of Code Farms Inc, and is only licensed to the user under the conditions
expressed in the License Agreement - see file license.txt.
If you need to discuss these issues, please contact Code Farms at
suppport@codefarms.com
