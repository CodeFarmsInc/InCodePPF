...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    float ratio=1.01; // this was originally 1
    unsigned objPerPage = (unsigned)(ratio*booksCount / BOOKS_TO_AUTHORS_RATIO);
    unsigned maxObjects = objPerPage * 2;
    Author::startPagerObj(objPerPage, maxObjects, maxObjects, 2);
    objPerPage = (int)(ratio*booksCount);
    maxObjects = objPerPage * 2;
    Book::startPagerObj(objPerPage, maxObjects, maxObjects, 2);
    objPerPage = (unsigned)(ratio*booksCount * MAX_AUTHORS_PER_BOOK / 2.0);
    maxObjects = objPerPage * 2;
    BookToAuthor::startPagerObj(objPerPage, maxObjects, maxObjects, 2);    
    objPerPage = 4096;
    maxObjects = 512*booksCount;
    PersistString::startPagerObj(1024, maxObjects, maxObjects, 2);
    // originally this was     (1024, objPerPage*100, maxObjects, 2)
