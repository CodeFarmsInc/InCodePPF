...
int booksToAuthors_Ring2::debugFun(PTR(BookToAuthor) tail){
    PTR(BookToAuthor) p,nxt,head; int h,t,ret;
...
PTR(BookToAuthor) const booksToAuthors_Ring2::next(PTR(BookToAuthor) tail, PTR(BookToAuthor) c){
    PTR(BookToAuthor) ret=c->ZZds.ZZbooksToAuthors.next;
    if(c==tail)ret=NULL;
    return ret; // return NULL when c is the tail
}

PTR(BookToAuthor) const booksToAuthors_Ring2::prev(PTR(BookToAuthor) tail, PTR(BookToAuthor) c){
    PTR(BookToAuthor) ret=c->ZZds.ZZbooksToAuthors.prev;
    if(ret==tail)ret=NULL;
    return ret; // return NULL when c is the tail
}

PTR(BookToAuthor) const booksToAuthors_Ring2::nextRing(PTR(BookToAuthor) c){
    return c->ZZds.ZZbooksToAuthors.next;
}

PTR(BookToAuthor) const booksToAuthors_Ring2::prevRing(PTR(BookToAuthor) c){
    return c->ZZds.ZZbooksToAuthors.prev;
}

PTR(BookToAuthor) booksToAuthors_Ring2::addHead(PTR(BookToAuthor) tail, PTR(BookToAuthor) c){
...
PTR(BookToAuthor) booksToAuthors_Ring2::addTail(PTR(BookToAuthor) tail, PTR(BookToAuthor) c){
...
PTR(BookToAuthor) booksToAuthors_Ring2::append(PTR(BookToAuthor) tail,PTR(BookToAuthor) c1, PTR(BookToAuthor) c2){
    PTR(BookToAuthor) nxt;
...
void booksToAuthors_Ring2::insert(PTR(BookToAuthor) c1, PTR(BookToAuthor) c2){
    PTR(BookToAuthor) prv;
...
PTR(BookToAuthor) booksToAuthors_Ring2::remove(PTR(BookToAuthor) tail, PTR(BookToAuthor) c){
    PTR(BookToAuthor) prv,nxt; PTR(BookToAuthor) t;
...
PTR(BookToAuthor) booksToAuthors_Ring2::sort(booksToAuthors_sortFun cmp, PTR(BookToAuthor) tail){
    PTR(BookToAuthor) a1,a2,t,t1,t2,p,nxt,subs,last,lastA1;
...
void booksToAuthors_Ring2::merge(PTR(BookToAuthor) s,PTR(BookToAuthor) t){
    PTR(BookToAuthor) u,v;
...
PTR(BookToAuthor) booksToAuthors_Ring2Iterator::fromHead(PTR(BookToAuthor) p){ 
...
PTR(BookToAuthor) booksToAuthors_Ring2Iterator::fromTail(PTR(BookToAuthor) p){ 
    dir=1;
    if(p==NULL){nxt=tail=NULL; return NULL;}
    tail=p;
...
PTR(BookToAuthor) const booksToAuthors_Ring2Iterator::next(){ 
    PTR(BookToAuthor) c;
...
void booksToAuthors_Ring2Iterator::start(PTR(BookToAuthor) p){ 
    PTR(BookToAuthor) ret;
...
PTR(BookToAuthor) const booksToAuthors_Ring2Iterator::operator++(){ 
    PTR(BookToAuthor) ret;
