...
int books_Ring2::debugFun(PTR(Book) tail){
    PTR(Book) p,nxt,head; int h,t,ret;
...
PTR(Book) const books_Ring2::next(PTR(Book) tail, PTR(Book) c){
    PTR(Book) ret=c->ZZds.ZZbooks.next;
    if(c==tail)ret=NULL;
    return ret; // return NULL when c is the tail
}

PTR(Book) const books_Ring2::prev(PTR(Book) tail, PTR(Book) c){
    PTR(Book) ret=c->ZZds.ZZbooks.prev;
    if(ret==tail)ret=NULL;
    return ret; // return NULL when c is the tail
}

PTR(Book) const books_Ring2::nextRing(PTR(Book) c){
    return c->ZZds.ZZbooks.next;
}

PTR(Book) const books_Ring2::prevRing(PTR(Book) c){
    return c->ZZds.ZZbooks.prev;
}

PTR(Book) books_Ring2::addHead(PTR(Book) tail, PTR(Book) c){
    PTR(Book) head;
...
PTR(Book) books_Ring2::addTail(PTR(Book) tail, PTR(Book) c){
...
PTR(Book) books_Ring2::append(PTR(Book) tail,PTR(Book) c1, PTR(Book) c2){
    PTR(Book) nxt;
...
void books_Ring2::insert(PTR(Book) c1, PTR(Book) c2){
    PTR(Book) prv;
...
PTR(Book) books_Ring2::remove(PTR(Book) tail, PTR(Book) c){
    PTR(Book) prv,nxt; PTR(Book) t;
...
PTR(Book) books_Ring2::sort(books_sortFun cmp, PTR(Book) tail){
    PTR(Book) a1,a2,t,t1,t2,p,nxt,subs,last,lastA1;
...
void books_Ring2::merge(PTR(Book) s,PTR(Book) t){
    PTR(Book) u,v;
...
PTR(Book) books_Ring2Iterator::fromHead(PTR(Book) p){ 
    PTR(Book) ret;
...
PTR(Book) books_Ring2Iterator::fromTail(PTR(Book) p){ 
    dir=1;
    if(p==NULL){nxt=tail=NULL; return NULL;}
    tail=p;
...
PTR(Book) const books_Ring2Iterator::next(){ 
    PTR(Book) c;
...
void books_Ring2Iterator::start(PTR(Book) p){ 
    PTR(Book) ret;
...
PTR(Book) const books_Ring2Iterator::operator++(){ 
    PTR(Book) ret;
