...
int authors_Ring2::debugFun(PTR(Author) tail){
    PTR(Author) p,nxt,head; int h,t,ret;
...
PTR(Author) const authors_Ring2::next(PTR(Author) tail, PTR(Author) c){
    PTR(Author) ret=c->ZZds.ZZauthors.next;
    if(c==tail)ret=NULL;
    return ret; // return NULL when c is the tail
}

PTR(Author) const authors_Ring2::prev(PTR(Author) tail, PTR(Author) c){
    PTR(Author) ret=c->ZZds.ZZauthors.prev;
    if(ret==tail)ret=NULL;
    return ret; // return NULL when c is the tail
}

PTR(Author) const authors_Ring2::nextRing(PTR(Author) c){
    return c->ZZds.ZZauthors.next;
}

PTR(Author) const authors_Ring2::prevRing(PTR(Author) c){
    return c->ZZds.ZZauthors.prev;
}

PTR(Author) authors_Ring2::addHead(PTR(Author) tail, PTR(Author) c){
    PTR(Author) head;
...
PTR(Author) authors_Ring2::addTail(PTR(Author) tail, PTR(Author) c){
...
PTR(Author) authors_Ring2::append(PTR(Author) tail,PTR(Author) c1, PTR(Author) c2){
    PTR(Author) nxt;
...
void authors_Ring2::insert(PTR(Author) c1, PTR(Author) c2){
    PTR(Author) prv;
...
PTR(Author) authors_Ring2::remove(PTR(Author) tail, PTR(Author) c){
    PTR(Author) prv,nxt; PTR(Author) t;
...
PTR(Author) authors_Ring2::sort(authors_sortFun cmp, PTR(Author) tail){
    PTR(Author) a1,a2,t,t1,t2,p,nxt,subs,last,lastA1;
...
void authors_Ring2::merge(PTR(Author) s,PTR(Author) t){
    PTR(Author) u,v;
...
PTR(Author) authors_Ring2Iterator::fromHead(PTR(Author) p){ 
    PTR(Author) ret;
...
PTR(Author) authors_Ring2Iterator::fromTail(PTR(Author) p){ 
    dir=1;
    if(p==NULL){nxt=tail=NULL; return NULL;}
    tail=p;
...
PTR(Author) const authors_Ring2Iterator::next(){ 
    PTR(Author) c;
...
void authors_Ring2Iterator::start(PTR(Author) p){ 
    PTR(Author) ret;
...
PTR(Author) const authors_Ring2Iterator::operator++(){ 
    PTR(Author) ret;
