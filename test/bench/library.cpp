...
void CreateLibrary(bool genAbstract, unsigned booksCount, bool testing,
		                       unsigned timeStartOpen);
void OpenLibrary(bool testing, unsigned timeStartOpen);
...
int main(int argc, char *argv[])
{
    ...
    // PersistFactory::warmDiskCache(create);
    PersistFactory::preloadPages(create);

    //unsigned page = 16384;        
    Library::startPager(128,2,512,0);
    /*unsigned pgs = 1;
    unsigned p = 1;
    ...
    */
    ...
    if(create)
    {
        CreateLibrary(genAbstract, booksCount, testing, time1);        
    }
    else
    {        
        OpenLibrary(testing, time1);        
        booksCount = 0;
    }
...
void CreateLibrary(bool genAbstract, unsigned booksCount,bool testing, unsigned timeStartOpen)
{    
